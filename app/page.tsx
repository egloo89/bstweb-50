          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#contact" className="inline-block">
                <Button className="bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 text-white px-10 py-7 text-xl h-auto">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center">함께 성장할 준비가 되셨나요?</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center gap-4">
                  <div className="bg-yellow-500/20 p-4 rounded-full">
                    ...
                    >
                      <path d="M12 3C6.477 3 2 6.477 2 11c0 1.421.381 2.75 1.043 3.9L1 23l8.1-1.043C10.25 22.619 11.579 23 12 23c5.523 0 10-3.477 10-8s-4.477-8-10-8z" />
                    </svg>
                  </div>
                  <a href="http://pf.kakao.com/_BjtHn" target="_blank" rel="noopener noreferrer" className="inline-block">
                    <Button className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black font-bold text-2xl px-12 py-6">
                      카카오 채널로 문의하기
                    </Button>
                  </a>
                </div>
            ...
            >
              <form onSubmit={handleSubmit} className="bg-zinc-800/50 border border-white/10 p-8 rounded-xl">
                <h3 className="text-2xl font-bold mb-6">고퀄리티 홈페이지 제작 문의</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-2xl font-bold mb-2">
                      전화번호
                    </label>
                    <Input
                      id="phone"
                  ...
                  <Button
                    ...
                    className={cn(
                      "w-full bg-gradient-to-r from-purple-600 to-cyan-500 hover:from-purple-700 hover:to-cyan-600 text-white text-xl font-bold",
          ...
          <div className="grid md:grid-cols-3 gap-8 justify-items-center text-center">
            <div>
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <span className="text-2xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-500 to-cyan-400">
                  부스트웹
                </span>
              </div>
              <p className="text-xl text-gray-400 mb-6 tracking-wide">{"비즈니스 목표, 시장, 브랜드 방향을 바탕으로\n가장 적합한 웹 구축 방법을 제안드립니다."}</p>
              <div className="flex items-center justify-center gap-4">
                <div className="bg-yellow-500/20 p-4 rounded-full">
                  <svg
                    className="h-8 w-8 text-yellow-500"
            ...
            <div>
              <h4 className="text-2xl font-semibold mb-4">서비스</h4>
            ...
            <div>
              <h4 className="text-2xl font-semibold mb-4">회사</h4>
              <ul className="space-y-3">
                <li>
                  <a href="#about" className="text-xl text-gray-400 hover:text-purple-400 transition-colors">
                    회사 소개
                  </a>
                </li>
                <li>
                  <a href="#team" className="text-xl text-gray-400 hover:text-purple-400 transition-colors">
                    팀
                  </a>
                </li>
                <li>
