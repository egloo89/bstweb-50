                ...
                <form onSubmit={handleSubmit} className="bg-zinc-800/50 border border-white/10 p-6 md:p-8 rounded-xl">
                  ...
                  <div className="space-y-4 md:space-y-5">
                    ...
                    <div className="pt-2 flex items-center justify-center gap-3 md:gap-4">
                      ...
                      <a href="http://pf.kakao.com/_BjtHn" target="_blank" rel="noopener noreferrer" className="flex-shrink-0" onClick={(e) => e.stopPropagation()}>
                        <Button type="button" className="bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-black font-bold text-sm md:text-base px-4 md:px-6 py-2 md:py-3 whitespace-nowrap">
                          카카오 채널로 문의하기
                        </Button>
                      </a>
                    </div>
